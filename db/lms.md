...
### 1、LSM树的核心思想
![image](https://github.com/yincongcyincong/ms/blob/main/image/lms1.png)
...
1) size-tiered 策略
![image](https://github.com/yincongcyincong/ms/blob/main/image/lms3.png)
...
2) leveled策略
![image](https://github.com/yincongcyincong/ms/blob/main/image/lms4.png)
...
![image](https://github.com/yincongcyincong/ms/blob/main/image/lms5.png)

每一层的SSTable是全局有序的
假设存在以下这样的场景:

1) L1的总大小超过L1本身大小限制：
![image](https://github.com/yincongcyincong/ms/blob/main/image/lms6.png)

此时L1超过了最大阈值限制
2) 此时会从L1中选择至少一个文件，然后把它跟L2有交集的部分(非常关键)进行合并。生成的文件会放在L2:
![image](https://github.com/yincongcyincong/ms/blob/main/image/lms7.png)
...
![image](https://github.com/yincongcyincong/ms/blob/main/image/lms8.png)

需要注意的是，多个不相干的合并是可以并发进行的：
![image](https://github.com/yincongcyincong/ms/blob/main/image/lms9.png)
